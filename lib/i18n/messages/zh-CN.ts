...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.defaultSessionPath": "默认会话路径",
    "settings.defaultSessionPathDescription": "工作路径落在这个文件夹下（包括该文件夹本身）的会话，会被识别为无项目的临时会话，显示在【最近】中。默认的 pi-cwd-* 临时目录始终会被识别。",
    "settings.defaultSessionPathEmpty": "尚未设置默认会话路径。",
    "settings.defaultSessionPathPick": "选择文件夹",
    "settings.defaultSessionPathChange": "更改",
    "settings.defaultSessionPathClear": "清除",
    "settings.defaultSessionPathSaving": "保存中…",
    "settings.defaultSessionPathError": "无法更新默认会话路径。",
    ...
    "header.moreMenu": "更多",
    "rightPanel.reviewTab": "审查",
    "rightPanel.filesTab": "文件",
    "rightPanel.files2Truncated": "文件列表已被截断，更深层级的文件可能未显示。",
    "rightPanel.files2Loading": "正在加载文件树…",
    "rightPanel.files2Open": "打开",
    "rightPanel.reviewHeader": "审查",
    "rightPanel.reviewLoading": "正在加载 diff…",
    "rightPanel.reviewEmpty": "工作区干净，没有需要审查的变更。",
    "rightPanel.reviewNotARepository": "当前目录不是 Git 仓库。",
    "rightPanel.reviewUnsupported": "该文件的 diff 不可用（二进制文件、过大或不在仓库内）。",
    ...
    "sidebar.projects": "项目",
    "sidebar.recent": "最近",
    "sidebar.emptyProjects": "暂无项目 — 点击 + 添加文件夹。",
    "sidebar.addProject": "添加文件夹",
    "sidebar.newSessionInFolder": "在该文件夹中新建会话",
    "sidebar.folderAlreadyExists": "该文件夹已有会话，已跳过。",
    "sidebar.confirmDeleteSession": "确定删除该会话？",
    "sidebar.confirmDeleteProject": "确定删除该项目？",
    "sidebar.deleteProjectDetail": "这将删除该文件夹下的 {count} 个会话。",
    "sidebar.deleteProjectEmpty": "没有可删除的会话。",
    "sidebar.collapse": "折叠",
    "sidebar.expand": "展开",
    "files.modified": "已修改",
    "files.added": "已添加",
    ...
    "chat.renameSessionTitle": "点击重命名会话",
    ...
    "i18n.compactionShow": "展开压缩详情",
    "i18n.compactionHide": "收起压缩详情",
    "i18n.compactionShowSummary": "展开摘要",
