...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.defaultSessionPath": "預設工作路徑",
    "settings.defaultSessionPathDescription": "工作路徑落在此資料夾下（含該資料夾本身）的工作階段，會被視為無專案的臨時工作階段，顯示於【最近】中。預設的 pi-cwd-* 臨時目錄始終會被識別。",
    "settings.defaultSessionPathEmpty": "尚未設定預設工作路徑。",
    "settings.defaultSessionPathPick": "選擇資料夾",
    "settings.defaultSessionPathChange": "變更",
    "settings.defaultSessionPathClear": "清除",
    "settings.defaultSessionPathSaving": "儲存中…",
    "settings.defaultSessionPathError": "無法更新預設工作路徑。",
    ...
    "header.moreMenu": "更多",
    "rightPanel.reviewTab": "審查",
    "rightPanel.filesTab": "檔案",
    "rightPanel.files2Truncated": "檔案列表已被截斷，更深層級的檔案可能未顯示。",
    "rightPanel.files2Loading": "正在載入檔案樹…",
    "rightPanel.files2Open": "開啟",
    "rightPanel.reviewHeader": "審查",
    "rightPanel.reviewLoading": "正在載入 diff…",
    "rightPanel.reviewEmpty": "工作區乾淨，沒有需要審查的變更。",
    "rightPanel.reviewNotARepository": "當前目錄不是 Git 倉庫。",
    "rightPanel.reviewUnsupported": "該檔案的 diff 無法使用（二進位檔案、過大或不在倉庫內）。",
    ...
    "sidebar.projects": "專案",
    "sidebar.recent": "最近",
    "sidebar.emptyProjects": "目前沒有專案 — 點選 + 新增資料夾。",
    "sidebar.addProject": "新增資料夾",
    "sidebar.newSessionInFolder": "在此資料夾中新增工作階段",
    "sidebar.folderAlreadyExists": "該資料夾已有工作階段，已略過。",
    "sidebar.confirmDeleteSession": "確定刪除此工作階段？",
    "sidebar.confirmDeleteProject": "確定刪除此專案？",
    "sidebar.deleteProjectDetail": "這將刪除此資料夾下的 {count} 個工作階段。",
    "sidebar.deleteProjectEmpty": "沒有可刪除的工作階段。",
    "sidebar.collapse": "摺疊",
    "sidebar.expand": "展開",
    "files.modified": "已修改",
    "files.added": "已新增",
    ...
    "chat.thinking": "正在思考...",
    "chat.renameSession": "重新命名會話",
    "chat.renameSessionTitle": "點擊重新命名會話",
    ...
    "i18n.compactionShow": "展開壓縮詳情",
    "i18n.compactionHide": "收起壓縮詳情",
    "i18n.compactionShowSummary": "展開摘要",
    "i18n.compactionHideSummary": "收起摘要",
