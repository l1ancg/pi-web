...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.defaultSessionPath": "Default session path",
    "settings.defaultSessionPathDescription": "Sessions whose path lives under this folder (including the folder itself) appear under Recent as project-less temporary sessions. The default pi-cwd-* scratch folders are always admitted.",
    "settings.defaultSessionPathEmpty": "No default session path set.",
    "settings.defaultSessionPathPick": "Pick folder",
    "settings.defaultSessionPathChange": "Change",
    "settings.defaultSessionPathClear": "Clear",
    "settings.defaultSessionPathSaving": "Saving…",
    "settings.defaultSessionPathError": "Could not update default session path.",
    ...
    "header.moreMenu": "More",
    "rightPanel.reviewTab": "Review",
    "rightPanel.filesTab": "Files",
    "rightPanel.files2Truncated": "File listing was truncated; deeper items may be missing.",
    "rightPanel.files2Loading": "Loading file tree…",
    "rightPanel.files2Open": "Open",
    "rightPanel.reviewHeader": "Review",
    "rightPanel.reviewLoading": "Loading diff…",
    "rightPanel.reviewEmpty": "Working tree is clean. No changes to review.",
    "rightPanel.reviewNotARepository": "This directory is not a Git repository.",
    "rightPanel.reviewUnsupported": "This file's diff is not available (binary, too large, or out-of-repo).",
    ...
    "sidebar.emptyProjects": "No projects yet — click + to add a folder.",
    "sidebar.addProject": "Add folder",
    "sidebar.newSessionInFolder": "New session in {path}",
    "sidebar.folderAlreadyExists": "This folder already has sessions — skipped.",
    "sidebar.confirmDeleteSession": "Delete session?",
    "sidebar.confirmDeleteProject": "Delete project?",
    "sidebar.deleteProjectDetail": "This will delete {count} session(s) in this folder.",
    "sidebar.deleteProjectEmpty": "No sessions to delete.",
    ...
    "chat.renameSessionTitle": "Click to rename session",
    ...
    "chat.jumpToBottom": "Jump to latest message",
    ...
    "i18n.sessionBranches": "Session branches",
    ...
    "i18n.compactionShow": "Show compaction details",
    "i18n.compactionHide": "Hide compaction details",
    "i18n.compactionShowSummary": "Show summary",
    "i18n.compactionHideSummary": "Hide summary",
